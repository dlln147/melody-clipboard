...
Every release also includes a `SHA256SUMS.txt` you can use to verify your
download, and `.app.tar.gz` updater artifacts (not needed for a normal
install). Exact filenames are generated by GitHub/the Tauri bundler and
documented precisely in [`docs/RELEASING.md`](docs/RELEASING.md); the table
